# speechtotext.benchmark.customBenchmarks.AmazonAPIBenchmark


### _class_ AmazonAPIBenchmark(with_cleaning=True)
...
#### MODEL_BASE(_: [`str`](https://docs.python.org/3/library/stdtypes.html#str_ _ = 'AmazonAPI_ )
Name of base model.
