# speechtotext.benchmark.customBenchmarks.AssemblyAIAPIBenchmark


### _class_ AssemblyAIAPIBenchmark(with_cleaning=True)
...
#### MODEL_BASE(_: [`str`](https://docs.python.org/3/library/stdtypes.html#str_ _ = 'AssemblyAIAPI_ )
Name of base model.
