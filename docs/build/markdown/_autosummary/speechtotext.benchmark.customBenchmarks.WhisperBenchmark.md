# speechtotext.benchmark.customBenchmarks.WhisperBenchmark


### _class_ WhisperBenchmark(with_cleaning=True)
...
#### MODEL_BASE(_: [`str`](https://docs.python.org/3/library/stdtypes.html#str_ _ = 'Whisper_ )
Name of base model.
