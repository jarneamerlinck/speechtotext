# speechtotext.model.speechmaticsWrapper.SpeechmaticsAPIWrapper


### _class_ SpeechmaticsAPIWrapper(model_version)
...
* **Parameters**
    ...
    **model_version** ([*SpeechmaticsAPIVersion*](speechtotext.model.speechmaticsWrapper.SpeechmaticsAPIVersion.md#speechtotext.model.speechmaticsWrapper.SpeechmaticsAPIVersion)) – Model version of SPEECHMATICS STT API to use.
...
#### CONNECTION_URL(_: [`str`](https://docs.python.org/3/library/stdtypes.html#str_ _ = 'wss://eu2.rt.speechmatics.com/v2/_ )
Connection url for the API.
